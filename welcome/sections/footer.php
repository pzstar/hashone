    ...
    <div class="recomended-plugin-wrap">
        ...
        <div class="recommended-plugins">
            ...
            <div class="plugin-title-wrap">
                ...
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/total-plus/construction/" class="button button-primary"><?php echo esc_html__('Preview', 'hashone'); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="recommended-plugins">
            ...
            <div class="plugin-title-wrap">
                ...
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/total-plus/main/" class="button button-primary"><?php echo esc_html__('Preview', 'hashone'); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="recommended-plugins">
            ...
            <div class="plugin-title-wrap">
                ...
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/total-plus/creative-agency" class="button button-primary"><?php echo esc_html__('Preview', 'hashone'); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="recommended-plugins">
            ...
            <div class="plugin-title-wrap">
                ...
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/total-plus/one-page" class="button button-primary"><?php echo esc_html__('Preview', 'hashone'); ?></a>
                </div>
            </div>
        </div>
